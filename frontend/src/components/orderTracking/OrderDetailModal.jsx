...
export default function OrderDetailModal({
  ...
  handleSavePaymentEdit, handleSaveItemWarrantyDate, handleToggleInstallation, handleUpdateStatus,
  ...
  const downloadGatepass = async () => {
    ...
    try {
      ...
      link.href  = url;
      const orderId = selectedBatch?.items?.[0]?.orderid || orderGuid;
      link.download = `gatepass-${orderId}.pdf`;
      link.click();
