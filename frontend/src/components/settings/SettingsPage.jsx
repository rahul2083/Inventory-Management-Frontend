...
const UsersComp = lazy(() => import('../users/Users'));
const UserActivityComp = lazy(() => import('../userActivity/UserActivity'));
const ReportsComp = lazy(() => import('../reports/Reports'));
const ProfilePageComp = lazy(() => import('../profile/ProfilePage'));
