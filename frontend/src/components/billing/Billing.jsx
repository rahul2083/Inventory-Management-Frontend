...
export default function Billing({
    ...
    const handleEditClick = (group) => {
        ...
        setEditForm({
            ...
            invoiceDate: firstItem.invoiceDate ? toLocalDateStr(firstItem.invoiceDate) : "",
                ...
                <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl my-8">
                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
                            ...
                            <button type="button" onClick={() => setEditingBatch(null)} className="p-1.5 hover:bg-slate-100 rounded-lg transition">
                        ...
                        <form onSubmit={handleSaveEdit}>
                            ...
                            <div className="flex gap-2 justify-end px-5 py-3 border-t border-slate-100 bg-slate-50 rounded-b-2xl">
                                <button type="button" onClick={() => setEditingBatch(null)} className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-600 hover:bg-slate-50 transition">
                                    Cancel
                                </button>
