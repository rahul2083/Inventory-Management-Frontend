                  ...
                  <div key={req.guid} className="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 p-5 space-y-4">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-100">
                      ...
                      <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[11px] font-semibold ${status.bg}`}>
                        <StatusIcon size={12} className={req.status === "pending" ? "animate-pulse" : ""} />
                    ...
                    <div className="flex gap-4">
                      {["Printer", "PC"].map(cat => (
                        <label key={cat} className="flex items-center gap-2 cursor-pointer">
                          ...
                          <span className={`text-sm font-bold ${approveForm.mainCategory === cat ? 'text-emerald-600' : 'text-slate-500'}`}>{cat}</span>
                        </label>
                      ))}
                    </div>
                  </div>
                      ...
                      onClick={async () => {
                        ...
                        try {
                          const payload = {
                            ...
                            category: approveForm.mainCategory === "Printer" ? approveForm.category : "Computing",
                            ...
                            cpu: approveForm.mainCategory !== "Printer" ? approveForm.cpu : null,
                            ram: approveForm.mainCategory !== "Printer" ? approveForm.ram : null,
                            ssd: approveForm.mainCategory !== "Printer" ? approveForm.ssd : null,
